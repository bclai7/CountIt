...
public class SettingsActivityA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vibrateSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                vibrateOn=isChecked;
                SharedPreferences sharedPref = SettingsActivityA.this.getPreferences(Context.MODE_PRIVATE);
        ...
        resetSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                SharedPreferences sharedPref = SettingsActivityA.this.getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putBoolean(resetKey, isChecked);
                editor.commit();
                Log.d("test", "isChecked: "+isChecked);
                Log.d("test", " ");
            }
        ...
        screenSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                SharedPreferences sharedPref = SettingsActivityA.this.getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putBoolean(screenKey, isChecked);
                editor.commit();
                Log.d("test", "isChecked: "+isChecked);
                Log.d("test", " ");
            }
        ...
        volumeSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                SharedPreferences sharedPref = SettingsActivityA.this.getPreferences(Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPref.edit();
                editor.putBoolean(volumeKey, isChecked);
                editor.commit();
                Log.d("test", "isChecked: "+isChecked);
                Log.d("test", " ");
            }
